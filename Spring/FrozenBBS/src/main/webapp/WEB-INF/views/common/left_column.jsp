...
<div class="w3-col m3">
  ...
  <div class="w3-card w3-round w3-white">
    <div class="w3-container">
     ...
     <p class="w3-center">${loginData.id}</p>
     <hr>
     <p><i class="fa fa-pencil fa-fw w3-margin-right w3-text-theme"></i> ID : ${loginData.id}</p>
     <p><i class="fa fa-home fa-fw w3-margin-right w3-text-theme"></i> 오늘 기분 : ${sessionScope.UserMood}</p>
     <%--${sessionScope.어쩌구} 에서 ${loginData.어쩌구}로 변경한 셈 --%>
     <p><i class="fa fa-birthday-cake fa-fw w3-margin-right w3-text-theme"></i> ${loginData.regidate}</p>
    </div>
  </div>
  <br>
