				...
				<div class="w3-container w3-padding w3-light-grey w3-round-large ">
					...
					<form action="/member/join" class="appForm" method="post">
						...
						<!-- user_id -->
							...
							<div class="app_content"><input type="text" name="id" class="w3-input w3-border w3-round" id="id_lbl" placeholder="아이디를 입력해주세요" required/></div>
						
						<!-- name -->
							<label for="name_lbl" class="w3-container w3-padding">이메일</label>
							<div class="app_content"><input type="text" name="emailId" class="w3-input w3-border w3-round" id="name_lbl" placeholder="이메일을 입력해주세요" required/></div>

                        <!-- name -->
                            <label for="name_lbl" class="w3-container w3-padding">이메일주소</label>
                            <div class="app_content"><input type="text" name="emailAddress" class="w3-input w3-border w3-round" id="name_lbl" placeholder="이메일주소를 입력해주세요" required/></div>


						<!-- password -->	
							<label for="pwd_lbl" class="w3-container w3-padding">비밀번호</label>
							<div class="app_content"><input type="password" name="pw" class="w3-input w3-border w3-round" id="pwd_lbl" placeholder="비밀번호를 입력해주세요" required/></div>
